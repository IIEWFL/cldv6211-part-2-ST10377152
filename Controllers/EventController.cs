...
namespace EventEase.Controllers
{
    public class EventController : Controller
    {
        ...
        {
            var @event = await _context.Events.Include(b => b.Bookings).FirstOrDefaultAsync(e => e.EventId == id);
            if (@event == null)
            {
               return NotFound();
            }
            ...
            {
                TempData["ErrorMessage"] = "Cannot delete event";
                return RedirectToAction(nameof(Index));
            }

            _context.Events.Remove(@event);
            await _context.SaveChangesAsync();
            TempData["SuccessMesage"] = "event deleted successfully";
            return RedirectToAction(nameof(Index));
        }

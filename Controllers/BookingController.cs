...
namespace EventEase.Controllers
{
    public class BookingController : Controller
    {
        ...
        {
            var pOEDBContext = _context.BookingViews;
        ...
        public async Task<IActionResult> Create([Bind("BookingId,VenueId,EventId,BookingDate")] Booking booking)
        {
            ...
            ViewData["EventId"] = new SelectList(_context.Events, "EventName", "EventId", booking.EventId);
            ViewData["VenueId"] = new SelectList(_context.Venues, "VenueName", "VenueId", booking.VenueId);
            return View(booking);
        }
...
namespace EventEase.Controllers
{
    public class BookingController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            {
                ModelState.AddModelError("", "No events or venues available. Please add some first.");
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Create([Bind("VenueId,EventId,BookingDate")] Booking booking)
        {
            if (!ModelState.IsValid)
            {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    if (!_context.Events.Any(e => e.EventId == booking.EventId) || !_context.Venues.Any(v => v.VenueId == booking.VenueId))
                    {
                        ModelState.AddModelError("", "The selected Event or Venue does not exist.");
                    }
                    else
                    {
                        _context.Add(booking);
